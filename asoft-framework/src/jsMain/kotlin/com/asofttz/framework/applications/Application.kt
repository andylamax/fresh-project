package com.asofttz.framework.applications

import com.asofttz.framework.applications.Application.Props
import com.asofttz.framework.applications.Application.State
...
import com.asofttz.module.react.toColor
    ...
    private fun RBuilder.appBar() = styledSection {
        styledDiv {
            ...
            styledDiv {
                ...
                styledDiv {
                    css {
                        backgroundColor = props.theme.text.onPrimary.main.toColor()
                        borderRadius = 50.pct
                        height = 1.5.em
                        width = 1.5.em
